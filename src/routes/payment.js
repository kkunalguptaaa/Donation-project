...
var PaytmConfig = {
	mid: "YceYFo48722068668859",
	key: "m2kyGT2Dtj!yxK#D",
	website: "WEBSTAGING"
}
...
router.post('/',(req,res)=>{
	...
	const MOBILE_NO=req.body.MOBILE_NO;
			...
			params['ORDER_ID']			= 'OID'  + new Date().getTime();
			params['CUST_ID'] 			= 'CID' + new Date().getTime();
			params['TXN_AMOUNT']			= TXN_AMOUNT;
			params['CALLBACK_URL']		= 'http://localhost:'+port+'/payment/callback';
			params['EMAIL']				= EMAIL;
        ...
        checksum_lib.genchecksum(params, PaytmConfig.key, function (err, checksum) {
            ...
            var post_req = https.request(options, function(post_res) {
                ...
                post_res.on('end', function(){
                    ...
                    // res.write(html);
                    // res.end();
                    req.flash('data',_result)
                    res.redirect('/')
                 //   res.render('index',{data:_result})
                });
            });
